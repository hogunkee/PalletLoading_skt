...
from custom_classes.cortexrigidprim import CustomCortexRigidPrim

# use custom CortexWorld class
from custom_classes.cortex_world import CortexWorld
...
def main(args):
    ...
    world.add_decider_network(behavior.make_decider_network(robot, model_path=args.model_path))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="./FCDQN_version5.pth")
