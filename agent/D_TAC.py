...
class D_TAC_Agent:
    ...
    def calculate_critic_loss(self, batch, weights):
        ...
        with torch.no_grad():
            # tsallis entropy
            _, action_probs, log_action_probs = self.pi(next_state, next_block, q_mask=next_qmask, tsallis=True, q_prime=1.2)
    ...
    def calculate_policy_loss(self, batch, weights):
        ...
        _, action_probs, log_action_probs = self.pi(state, block, tsallis=True, q_prime=1.2)
