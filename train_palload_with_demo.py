...
if __name__=='__main__':
    ...
    parser.add_argument("--model_path", default="1125_2317", type=str)
    ...
    model_path = os.path.join("results/models/Demo_%s.pth"%args.model_path)
    ...
    savename = "Demo_%s" % (now.strftime("%m%d_%H%M"))
    if not evaluation:
